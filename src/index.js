...
const song = new Audio("https://www.televisiontunes.com/uploads/audio/The%20Terminator.mp3");
let time = 0;
let timer;
let lastHole = 0;
let points = 0;
...
function startGame(){
  if (time > 0) {
    // this is needed to restart the game properly
    stopGame();
  }
